...
- [Nixy Plugins Suite](#nixy-plugins-suite)
    - [File Contains](#file-contains)
    - [File Dos2Unix](#file-dos2unix)
    - [File Exists](#file-exists)
    - [File Not Exists](#file-not-exists)
    - [File Rotate](#file-rotate)
    - [File Truncate](#file-truncate)
    - [Command Try Until](#command-try-until)
    - [Local Script Workflow Step](#local-script-workflow-step)
    - [Local Script Node Step](#local-script-node-step)
    - [Wait for Directory Exists](#wait-for-directory-exists)
    - [Wait for File Contains](#wait-for-file-contains)
    - [Wait for File Exists](#wait-for-file-exists)
    - [Wait for File Size](#wait-for-file-size)
    - [Wait for HTTP](#wait-for-http)
    - [Wait for Munin](#wait-for-munin)
    - [Wait for Ping](#wait-for-ping)
    - [Wait for Port Open](#wait-for-port-open)
    - [Wait for Sleep Workflow Step](#wait-for-sleep-workflow-step)
    - [Wait for Local Ping](#wait-for-local-ping)
    - [Wait for Local Port Open](#wait-for-local-port-open)
