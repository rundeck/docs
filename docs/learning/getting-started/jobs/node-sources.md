...
![](~@assets/img/nodes5-savesave.png)<br>
...
![](~@assets/img/nodes6-selectansiblesource.png)<br>
Provide details on where and how to connect to the new Node Source<br>
![](~@assets/img/nodes7-ansiblesourcedetails.png)<br>
...
![](~@assets/img/nodes8-savesave2.png)<br>
To commit your node source changes to the database, select the second green Save button at the bottom of the Sources page. There are warning messages at top and bottom to remind you to save here.<br>
...
![](~@assets/img/nodes9-modifysource.png)<br>
...
![](~@assets/img/nodes10-addenhancer.png)<br>
#### Enhancer Example
...
![](~@assets/img/nodes11-enhancerdetails.png)<br>
...
![](~@assets/img/nodes12-deletesource.png)<br>
