      ...
      children: [
        {
          ...
          sidebarDepth: 0,
          children: [
            ['/learning/solutions/automated-diagnostics/solution-overview.md','1. Solution Summary'],
            ['/learning/solutions/automated-diagnostics/getting-started.md', '2. Getting Started'],
            ['/learning/solutions/automated-diagnostics/tours.md', '3. Following the Tours'],
            ['/learning/solutions/automated-diagnostics/jobs.md', '4. Prebuilt Jobs'],
            ['/learning/solutions/automated-diagnostics/feedback-faq.md', '5. Feedback & FAQ'],
