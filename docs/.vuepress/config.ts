...
export default defineUserConfig({
  ...
  theme: hopeTheme({
    ...
    plugins: {
      ...
      redirect: {
        config: {
          ...
          '/developer/01-plugin-development.html': '/developer/',
          '/developer/02-plugin-annotations.html': '/developer/java-plugin-development.html',
          '/developer/03-step-plugins.html': '/developer/step-plugins.html',
          '/developer/03-model-source-plugins.html': '/developer/resource-model-source-plugins.html',
          '/developer/03-model-source-format-parser-generator-plugins.html': '/developer/resource-model-format-plugins.html',
          '/developer/04-node-execution-plugins.html': '/developer/node-executor-plugins.html',
          '/developer/04-file-copier-plugins.html': '/developer/file-copier-plugins.html',
          '/developer/05-notification-plugins.html': '/developer/notification-plugins.html',
          '/developer/06-logging-plugins.html': '/developer/logging-plugins.html',
          ...
          '/developer/14-file-upload-plugins.html': '/developer/file-upload-plugins.html',
          '/developer/16-webhook-plugins.html': '/developer/webhook-plugins.html',
    ...
    sidebar: {
      ...
      '/manual/document-format-reference/': sidebarDeveloper,
