...
| --- | ---------- | --- |
| Operating Systems | **Supported**:<br>[Red Hat Enterprise 8+/Oracle Linux 8+/Amazon Linux 2023](/administration/install/linux-rpm.md)<br>[Ubuntu 22.04.3+/Debian 12+](/administration/install/linux-deb.md)<br>[Windows Server 2019+](/administration/install/windows.md) | **Recommended**:<br>[Red Hat Enterprise 8+/Oracle Linux 8+/Amazon Linux 2023](/administration/install/linux-rpm.md)<br>[Ubuntu 22.04.3+/Debian 12+](/administration/install/linux-deb.md)<br>[Windows Server 2019+](/administration/install/windows.md) |
