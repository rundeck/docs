...
any "Job context variables" that are listed under [Job Variables Reference](/manual/jobs/job-variables.md). (Note: Some configuration properties of a plugin may not support this feature.)
