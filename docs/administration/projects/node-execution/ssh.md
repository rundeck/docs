...
Passwords, Passphrases and Private Keys can all be stored in the [Key Storage Facility](/administration/security/key-storage.md) and used with the built-in SSH plugins for Node Execution and File Copying.
