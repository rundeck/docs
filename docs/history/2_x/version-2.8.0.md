...
- Plugin properties support [`Options` multivalue type](/developer/plugin-properties.md) and [java annotations](http://rundeck.org/docs/developer/plugin-annotations.md#plugin-properties)
